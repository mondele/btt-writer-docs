...
**NOTE**: The choice of 'By Book' also enables the downloading of the translationWords (bible).
  ...
  #.	Once you have selected a book category, a list of available languagess opens. Select one or more languages and click Download.
 
  #.	The selected text(s) download (this may take a few minutes) and then you should receive a success message. Click Close.

  #.	The downloaded texts have a green check mark next to the name on the Source list.
