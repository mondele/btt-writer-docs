...
Note: At any time you can view the License Agreement, Statement of Faith, Translation Guidelines and the Software Licenses information from the Settings Menu. (See: `BTT Writer for Desktop: Modifying Program Settings <https://github.com/unfoldingWord-dev/btt-writer-Info/blob/master/docs/dSettings.rst>`_)
